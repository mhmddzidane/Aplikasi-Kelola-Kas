                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-primary" id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode'] ?>" data-ket="<?php echo $data['keterangan'] ?>" data-tgl="<?php echo $data['tgl'] ?>" data-jml="<?php echo $data['jumlah'] ?>">
                                            <i class="fa fa-edit"></i>Edit
                                        </a>
                                        <a onclick="return confirm('Yakin Akan Menghapus Data?')" href="?page=masuk&aksi=hapus&id=<?php echo $data['kode']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i>Hapus</a>
                                    </td>
                                </tr>
